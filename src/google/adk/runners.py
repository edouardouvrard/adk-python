...
class Runner:
  ...
  async def run_async(
    ...
    Args:
      ...
      run_config: The run config for the agent.
      request_context: Optional HTTP request context containing headers and
        other request metadata when running via FastAPI.
  ...
  def _new_invocation_context(
    ...
    Args:
        ...
        request_context: The HTTP request context for the context.
